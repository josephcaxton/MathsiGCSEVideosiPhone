...
-(IBAction)ShareThisAppViaMail:(id)sender{
	...
	if ([MFMailComposeViewController canSendMail]) {
        ...
        [SendMailcontroller setSubject:@"Learn and revise iGCSE Maths on the go - Maths App"];
...
-(void)ConnectToFaceBook {
    ...
    facebook = [[Facebook alloc] initWithAppId:@"221233574675790" andDelegate:self];
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   @"I’ve just started using a new Maths videos App! Hundreds of quality iGCSE Maths videos. You should check it out, or search LearnersCloud in your device’s App store.",  @"message",nil];
...
-(void)Twit {
    ...
    {
        NSString *UrlString = @"http://itunes.apple.com/us/app/igcse-maths-tutor-videos/id581472317?ls=1&mt=8";
