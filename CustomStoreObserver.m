...
-(NSString *)WorkOutSubsriptionInDays:(NSString*)theProductID{
    ...
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsigcseiphone3months"] ){
        
        return @"93";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsigcseiphone6months"] ){
        
        return @"186";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsigcseiphone9months"] ){
        
        return @"279";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"mathsigcseiphone12months"] ){
...
-(void)SendToLearnersCloud{
    ...
    VerificationAppID = @"10"; //Maths iPhone
